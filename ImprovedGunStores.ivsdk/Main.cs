...
namespace ImprovedGunStores
{
    public class Main : Script
    {
        ...
        private void BuyGuns()
        {
            ...
            if (!bIsHostile)
            {
                for (i = 0; i < numOfWeaponIDs; i++)
                {
                    ...
                    {
                        if (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("GL_PIST2") || IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("GL_SOON"))
                            CLEAR_HELP();
        ...
        private void SpawnBackroomWeapon()
        {
            ...
            //weapInAir = CreateObject_DontRequestModel((int)wModel, backroomPos.X + 0.5f, backroomPos.Y + 0.0f, backroomPos.Z, 90);
        ...
        private void SpawnDealer()
        {
            if (HasSpawned)
            {
                ...
                if (!DOES_CHAR_EXIST(GuardPeds[0]))
                {
                    ...
                    SET_ROOM_FOR_CHAR_BY_NAME(GuardPeds[0], "GtaMloRoom01");
                }
